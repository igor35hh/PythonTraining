...
class FtpTools:
    ...
    def configTransfer(self, site=defaultSite, rdir=defaultRdir, user=defaultUser):
...
if __name__ == '__main__':
    ...
    if xfermode == 'download':
        ...
        ftp.configTransfer(site='example.org.ua', rdir='books', user='igor')
        ftp.run(cleanTarget=ftp.cleanRemotes, transferAct=ftp.uploadDir)
    else:
        print('usage: ftptoolclass.py ["download" | "upload] [localdir]')
