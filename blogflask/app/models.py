...
class Comment(db.Model):
    ...
    def to_json(self):
        json_comment = {
            ...
            'body': self.body, 'body_html': self.body_html, 'timestamp': self.timestamp,
...
class User(UserMixin, db.Model):
    ...
    def to_json(self):
        json_user = {
            ...
            'username': self.username, 'member_since': self.member_since, 'last_seen': self.last_seen,
...
class Post(db.Model):
    ...
    def generate_fake(count=100):
        ...
        for i in range(count):
            ...
            p = Post(body=forgery_py.lorem_ipsum.sentences(randint(1, 5)),timestamp=forgery_py.date.date(True),
                     author=u)
            db.session.add(p)
            db.session.commit()
