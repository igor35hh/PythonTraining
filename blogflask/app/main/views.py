from flask import redirect, render_template, session, current_app, url_for, abort, request, make_response
...
def index():
    form = PostForm()
    if (current_user.can(Permission.WRITE_ARTICLES) or current_user.can(Permission.ADMINISTER)) and form.validate_on_submit():
