...
def before_request():
    if current_user.is_authenticated and not current_user.confirmed and request.endpoint and request.endpoint[:5] != 'auth.' and request.endpoint != 'static':
...
def login():
    ...
    if form.validate_on_submit():
        ...
        flash('Invalid username or passwword')
